<?php
// Controller untuk mengelola proses peminjaman dan pengembalian buku.
...
class LoanController
{
    ...
    {
        if (!$this->loanModel) {
            $this->respond(false, 'Model peminjaman belum tersedia', null, 500);
            return;
        }
    ...
    {
        if (!$this->loanModel || !$this->bookModel) {
            $this->respond(false, 'Model peminjaman atau buku belum tersedia', null, 500);
            return;
        }
