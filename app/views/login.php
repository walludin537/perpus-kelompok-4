...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-sm bg-white rounded-2xl shadow p-7 border border-gray100">
        <div class="text-center mb-6">
            <div class="w-12 h-12 rounded-xl bg-orange-200 flex items-center justifycenter mx-auto mb-2">
